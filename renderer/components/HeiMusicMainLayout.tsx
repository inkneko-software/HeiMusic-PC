    ...
    return (
        <Box sx={{ width: "calc(100vw)", height: "calc(100vh)", display: "flex", flexDirection: 'column', background: `url(${heimusicThemeContext.backgroundUrl})`, backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
            ...
            <Box sx={{ flexGrow: 1, width: "100%", display: "flex" }}>
                <LeftPannel sx={{ width: "196px", height:"calc(100vh - 64px)", overflowY:"auto", display: "flex", flexDirection: "column", background: theme.palette.pannelBackground.main }} />
                {/* 上部视窗 与 下部播放器 */}
                <Box sx={{ display: "flex", flexDirection: "column", flexGrow: 1 ,background: theme.palette.pannelBackground.light }}>
                    {/* <MusicAlbum sx={{ flexGrow: 1 }} /> */}
                    <Box sx={{flexGrow: 1}}>{children}</Box>
                    <MusicControlPannel sx={{ height: "76px"}} />
                </Box>
            </Box>
